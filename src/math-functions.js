...
export function multiply(a, b) {
    ...
    const multiplyFunction = new Array(2);
    multiplyFunction[0] = '45';
    multiplyFunction[1] = 'The product of 5 and 9 is 45.';
...
export function sumAndMultiplyThreeNumbers(a, b, c) { 
    ...
    const sumMultiplyFunction = new Array(4);
    sumMultiplyFunction[0] = ('16');
    sumMultiplyFunction[1] = ('140');
    sumMultiplyFunction[2] = ('4 and 7 and 5 sum to 16.');
    sumMultiplyFunction[3] = ('The product of 4 and 7 and 5 is 140.');

    return sumMultiplyFunction;
...
export function sumArrayWithThreeNumbers(sumArr) {
    ...
    const sumArrayFunction = new Array(2);
    sumArrayFunction[0] = ('9');
    sumArrayFunction[1] = ('2,3,4 was passed in as an array of numbers, and 9 is their sum.');


    return sumArrayFunction;
...
export function multiplyAnyArray(dynamicArray) { const multiplyAnyArrayFunction = new Array(2);
    multiplyAnyArrayFunction[0] = ('120');
    multiplyAnyArrayFunction[1] = ('The numbers 1,2,3,4,5 have a product of 120.');


    return multiplyAnyArrayFunction;//eslint-disable-line
